...
# Script to resume training from 670k checkpoint to 1M steps
# Usage: bash train_resume_670k_to_1M.sh [--resume-wandb] [--wandb-id=WANDB_ID]

# Default settings
RESUME_WANDB=false
WANDB_ID=""
WANDB_NAME="bert_768_12_12_670k_to_1M"
